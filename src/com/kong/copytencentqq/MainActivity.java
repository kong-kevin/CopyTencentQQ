package com.kong.copytencentqq;
...
import com.kong.copytencentqq.domain.Cheeses;
import com.kong.copytencentqq.drag.DragLayout;
import com.kong.copytencentqq.drag.DragLayout.Direction;
import com.kong.copytencentqq.drag.DragLayout.OnDragListener;
import com.kong.copytencentqq.drag.DragLayout.Status;
import com.kong.copytencentqq.drag.DragRelativeLayout;
import com.kong.copytencentqq.swipe.SwipeListAdapter;
...
public class MainActivity extends ListActivity implements OnClickListener {
	...
	private OnDragListener mDragListener = new OnDragListener() {
		...
		public void onStartOpen(Direction direction) {
			Utils.showToast(getApplicationContext(), "打开了: " + direction.toString()+"侧边栏");
		}
	};
