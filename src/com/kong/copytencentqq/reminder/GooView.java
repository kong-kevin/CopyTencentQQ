package com.kong.copytencentqq.reminder;
...
import com.kong.copytencentqq.util.GeometryUtil;
...
public class GooView extends View {
	...
	private ShapeDrawable drawGooView() {
		...
		if(xDiff != 0){
			...
			//分别获得经过两圆圆心连线的垂线与圆的交点（两条垂线平行，dragLineK相等）。
		...
		//3. 以两圆连线的0.618处作为 贝塞尔曲线 的控制点。（中间点附近的控制点）
